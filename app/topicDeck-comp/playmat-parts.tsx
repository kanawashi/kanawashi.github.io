...
export function Card ({title, sentence, empathyDegree, empathizeHandler}: TopicDetail) {
  ...
  return (
    <>
      ...
      <div mv-app="topicDeck" mv-storage="https://github.com/kanawashi/kanawashi.github.io/blob/mavo-experiment/database/database.json" mv-autosave="10" className="h-96 w-full mx-4 p-4 border-gray-800 bg-lime-200 shadow-lg shadow-gray-300 rounded-2xl">
